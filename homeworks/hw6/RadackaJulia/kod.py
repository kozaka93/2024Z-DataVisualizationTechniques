...
connections = [
    ...
    ("Klaus Mikaelson","Jenna Sommers"),
    ("Esther Mikaelson","Alaric Saltzman"),
    ("Katherine Pierce","Annabelle Zhu"),
    ("Annabelle Zhu","Logan Fell"),
    ("Elijah Mikaelson","Sage"),
    ("Sage","Troy"),
    ("Damon Salvatore","Abby Bennett"),
    ("Damon Salvatore","Isobel Flemming"),
    ("Katherine Pierce","Zhen Zhu"),
    ("Zhen Zhu","Annabelle Zhu"),
    ("Damon Salvatore","Charlotte"),
    ("Annabelle Zhu","Ben McKittrick"),
    ("Rose-Marie","Trevor")
]
