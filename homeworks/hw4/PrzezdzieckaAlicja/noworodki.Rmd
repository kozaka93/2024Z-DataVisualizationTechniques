...
Do wizualizacji wykorzystano dane dotyczące liczby pozostawionych noworodków w latach 2007-2023 oraz liczby urodzeń żywych w tych samych latach, udostępnione przez Fundację Gajusz. W analizie tych danych zastosowano zależność liczby pozostawień przeliczoną na 1000 żywych urodzeń w danym województwie. Pozwoliło to zobrazować skalę problemu na poszczególnych obszarach. Aby zaznaczyć dokładne wartości, dodano tabelę. Umożliwienie wyboru do dwóch województw na jednym wykresie oraz przedstawienie podsumowania dla całej Polski pozwala na porównanie wybranych obszarów między sobą lub z ogólną skalą problemu, nie zaburzając czytelności wykresu.
...
Ze względu na wysoką liczbę ludności oraz dużą liczbę urodzeń w województwie mazowieckim, liczba pozostawień noworodków jest tam również wyższa. Jednak po przeliczeniu tych danych na 1000 żywych urodzeń, wskaźnik w tym województwie nie jest tak wysoki w porównaniu do całej Polski czy innych województw. Porównując to z województwem lubuskim, w którym liczba pozostawień jest mniejsza, widać, że skala problemu jest zdecydowanie większa. Województwami z najwyższymi wskaźnikami pozostawień są: zachodniopomorskie, lubuskie i dolnośląskie. W większości województw w latach 2016-2018 obserwuje się spadek wskaźnika, natomiast w latach 2018-2023 zauważalny jest wzrost.
